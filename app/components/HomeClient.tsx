...
.chaos .sp-item:nth-child(2) { align-self: flex-end; margin-top: -44px; margin-right: 0; z-index: 2; }
.chaos .sp-item:nth-child(3) { align-self: flex-start; margin-top: -38px; margin-left: 8%; z-index: 6; }
.chaos .sp-item:nth-child(4) { align-self: flex-end; margin-top: -52px; margin-right: 6%; z-index: 5; }
.chaos .sp-item:nth-child(5) { align-self: flex-start; margin-top: -48px; margin-left: 28%; z-index: 7; }
.chaos .sp-item:nth-child(6) { align-self: flex-end; margin-top: -60px; margin-right: 14%; z-index: 8; }
.chaos .sp-item:nth-child(7) { align-self: flex-start; margin-top: -56px; margin-left: 38%; z-index: 9; }
