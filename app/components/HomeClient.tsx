...
@media (max-width: 860px) { .burger { display: flex; } nav.top ul { display: none; } }
      ...
      <section className="hero">
        <div className="carousel" id="carousel">
          ...
          <div className="slide" data-caption="Lecturas en terreno, desde el celular">
            <img src="/Iniciowomen.png" alt="Dirigente de un APR revisando el sistema en su celular" />
          </div>
        ...
        {/* Mobile menu overlay */}
        <div className={`mob-overlay${menuOpen ? ' open' : ''}`} aria-hidden={!menuOpen}>
          <div className="mob-inner">
            <div className="mob-head">
              <a href="/" className="mob-brand" onClick={() => setMenuOpen(false)}>
              ...
              <button className="mob-close" onClick={() => setMenuOpen(false)} aria-label="Cerrar menú">
